...
internal static class DateTimeExtensions
{
    ...
    private static readonly ChineseLunisolarCalendar LunisolarCalendar = new();
    ...
    {
        var year = LunisolarCalendar.GetYear(dt);
        var month = LunisolarCalendar.GetMonth(dt);
        var day = LunisolarCalendar.GetDayOfMonth(dt);
